var subscribeMessage			= 'Join the the mailing list:',
	...
	subscribeGo = function ( eventBubbling ) {
		...
		mailChimpListSubscribe( subscribeEmail.value, subscribeFname.value, subscribeLname.value, subscribeInterest.value, subscribeBirthday.value, subscribeAddress.value, subscribeWebsite.value, subscribeComment.value, subscribeInterest.value, subscribeBirthday.value, subscribeAddress.value, subscribeWebsite.value );
...
Template.MailChimpListSubscribe.rendered = function () {
	...
	subscribeAddress  = this.find( '.address' );

var subscribeMessage			= 'Join the the mailing list:',
	...
	mailChimpListSubscribe = function (email, fname, lname, comment, interest, list_id ) {
	...
	subscribeGo = function ( eventBubbling ) {
		...
		mailChimpListSubscribe( subscribeEmail.value, subscribeFname, subscribeLname, subscribeComment, subscribeInterest  );

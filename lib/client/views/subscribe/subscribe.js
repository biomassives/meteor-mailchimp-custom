var subscribeMessage			= 'Join the the mailing list:',
	...
	subscribeSuccess			= 'Thank you, please check your email to complete the process.',
...
Template.MailChimpListSubscribe.rendered = function () {
	...
	subscribeAddress1 = this.find( '.addr1');
        ...
        subscribeBirthdayDay  = this.find( '.birthdayd' );
	subscribeBirthdayMonth  = this.find( '.birthdaym' );
